  ...
  return (
    <div className="fixed inset-0 z-[9998]">
      ...
      <svg className="absolute inset-0 w-full h-full" style={{ pointerEvents: 'none' }}>
        ...
        {/* Highlight border */}
        <rect x={highlightX} y={highlightY} width={highlightW} height={highlightH} rx="8" ry="8" fill="none" stroke="rgba(99,102,241,0.7)" strokeWidth="2" />
        {/* Connector arrow from tooltip to highlight */}
        {arrowPath && (
          <>
            <defs>
              <marker id="tour-arrow" markerWidth="8" markerHeight="8" refX="7" refY="4" orient="auto">
                <polygon points="0,1 8,4 0,7" fill="rgba(99,102,241,0.8)" />
              </marker>
            </defs>
            <path d={arrowPath} fill="none" stroke="rgba(99,102,241,0.7)" strokeWidth="2" strokeLinecap="round" markerEnd="url(#tour-arrow)" />
          </>
        )}
      </svg>
