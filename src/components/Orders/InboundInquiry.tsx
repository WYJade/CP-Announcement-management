...
const TABLE_COLUMNS = [
  'Facility', 'Customer', 'Receipt #', 'Status', 'Rush', 'Title', 'PO #',
  'Destination Code', 'Ref#', 'Action',
]
    ...
    <div className="p-6">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-4 mb-5">
        <div className="grid grid-cols-4 gap-3">
          ...
          <div>
            <label className="block text-xs font-medium text-gray-500 mb-1">In Yard Date Range</label>
            <input type="text" placeholder="Select date range" className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm" />
          </div>
          <div>
            <label className="block text-xs font-medium text-gray-500 mb-1">Received Date Range</label>
            <input type="text" placeholder="Select date range" className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm" />
          </div>
          <div>
